...
class PackagingDAOTest {
    ...
    @Test
    public void findShipmentOptions_duplicatePackagingOptions_twoPackagingOptions() throws Exception {
        // GIVEN
        packagingDAO = new PackagingDAO(datastore);
        ...
        assertEquals(3, shipmentOptions.size(),
                "When fulfillment center has duplicates, return a ShipmentOption "
                        + "for each.");
    }
